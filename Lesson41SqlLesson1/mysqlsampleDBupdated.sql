...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`classicmodels1` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `offices` (
  `officeCode` int(10) AUTO_INCREMENT,
  `city` varchar(50) ,
  `phone` varchar(50) ,
  `addressLine1` varchar(50) ,
  `addressLine2` varchar(50) DEFAULT NULL,
...
CREATE INDEX idx_productLine ON productlines (productLine);
...
CREATE TABLE `products` (
  ...
  `MSRP` decimal(10,2),
  PRIMARY KEY (`id`),
  INDEX `idx_productCode` (`productCode`), -- Adding an index to productCode
